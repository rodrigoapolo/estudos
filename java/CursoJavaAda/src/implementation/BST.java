...
public class BST {
    ...
    public void deleteNote(int value){
        root = deleteNote(root, value);
    }

    private Node deleteNote(final Node root, final int value) {
        if(root == null) return null;
        if(value < root.value){
            root.left = deleteNote(root.left, value);
        }else if(value > root.value){
            root.right = deleteNote(root.right, value);
        }else {
