...
import br.com.rodrigo.apolo.chainofrespnsibility.problema.VendaCarroSevice;

import java.math.BigDecimal;

public class TesteVendaCarroComChainOfResponsibility {
    public static void main(String[] args) {
        VendaCarroSeviceComChainOfResponsibility vendaCarroSevice = new VendaCarroSeviceComChainOfResponsibility();
